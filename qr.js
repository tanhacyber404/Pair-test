		...
		try {
			...
			Qr_Code_By_Arslan_Tech.ev.on("connection.update", async (s) => {
				...
				if (connection == "open") {
				   ...
				   let session = await Qr_Code_By_Arslan_Tech.sendMessage(Qr_Code_By_Arslan_Tech.user.id, { text: 'Jerry-MD~' + b64data });
...
║❍ 𝐖𝐚𝐂𝐡𝐚𝐧𝐧𝐞𝐥: https://whatsapp.com/channel/0029Vb8cW3fHFxOw2UMoHW0B
║ ☬ ☬ ☬ ☬
╚═════════════════════╝
𒂀 Enjoy Jerry-MD
